...
export const products: Product[] = [
    {
        id: createUniqueId(),
        thumbnails: [
            "https://product.hstatic.net/1000075078/product/tra-dao-dua-luoi_0ed7ef25040848868b9e893021a2bc79_master.jpg",
        ...
        price: 52_000,
        information: [
            "Vị thơm ngọt của Dưa lưới và đào tươi chua chua, ngọt ngọt trên nền trà Oolong trứ danh cùng lớp foam cheese mỏng nhẹ vị mặn mặn tạo nên sự cân bằng cho thức uống, sẽ đem đến cho bạn, gia đình và bạn bè những giai điệu tươi vui cho mùa xuân mới. "
        ],
        story: [
            "Dưa Đào Sung Túc - Giai điệu tươi vui cho mùa xuân mới",
            "Mỗi hạt cà phê ra đời mang trong mình chất nguyên bản, tạo nên khác biệt đầy thú vị. ",
